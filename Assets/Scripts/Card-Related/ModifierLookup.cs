...
public static class ModifierLookup
{
    ...
    public static void LoadModifierTable() {
        ...
        descLookup = new Dictionary<Sprite, string>()
        {
            ...
            { Resources.Load<Sprite>(path + "plus2"), "Adds 2 to the base number of a card with the matching scroll symbol." },
            { Resources.Load<Sprite>(path + "plus4"), "Adds 4 to the base number of a card with the matching scroll symbol." },
            { Resources.Load<Sprite>(path + "plus6"), "Adds 6 to the base number of a card with the matching scroll symbol." },
            { Resources.Load<Sprite>(path + "plus8"), "Adds 8 to the base number of a card with the matching scroll symbol." },
